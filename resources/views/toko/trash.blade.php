      ...
      <div class="row">
        <div class="col-12">
          <div class="card card-primary card-outline">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <a href="/toko" class="btn btn-primary">Data Toko</a>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach($toko as $t)
                  <tr>
                      <td>{{ $t->nama_toko }}</td>
                      <td>
                          <button type="button" onclick="restoreConfirm({{ $t->id }})" class="btn btn-success">Restore</button>
                          <button type="button" onclick="deleteConfirm({{ $t->id }})" class="btn btn-danger">Hapus Permanen</button>
                      </td>
                  </tr>
                @endforeach
                </tbody>
