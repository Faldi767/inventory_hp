      ...
      <div class="row">
        <div class="col-12">
          <div class="card card-primary card-outline">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <a href="/brand" class="btn btn-primary">Data Brand</a>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach($brand as $b)
                  <tr>
                      <td>{{ $b->nama_brand }}</td>
                      <td>
                          <button type="button" onclick="restoreConfirm({{ $b->id }})" class="btn btn-success">Restore</button>
                          <button type="button" onclick="deleteConfirm({{ $b->id }})" class="btn btn-danger">Hapus Permanen</button>
                      </td>
                  </tr>
                @endforeach
                </tbody>
